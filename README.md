# TSH Recriutment Task

A streamlined web application designed to display an online catalog of products. It features a user-friendly interface with efficient search and filter functionalities. This initial version includes a homepage with a product list, search bar, pagination, and error handling. The project sets the foundation for future development and enhancements.

Key Tasks:

- Develop a homepage with an application bar, product list, and login button.
- Implement a text-based search function with 'active' and 'promo' filters.
- Create a pagination system for product listings.
- Design views for 'no products available' and API connection errors.
